...
public class MeteorItems {
	...
	public static final Item MeteoriteHelmet 			= new ItemEnchArmor(MeteoriteArmor, 3, 0).setEnch(MeteorsMod.Magnetization, 1).setUnlocalizedName("MeteoriteHelmet").setTextureName("MeteoriteHelmet");
	public static final Item MeteoriteBody 				= new ItemEnchArmor(MeteoriteArmor, 3, 1).setEnch(MeteorsMod.Magnetization, 1).setUnlocalizedName("MeteoriteChest").setTextureName("MeteoriteChest");
	public static final Item MeteoriteLegs 				= new ItemEnchArmor(MeteoriteArmor, 3, 2).setEnch(MeteorsMod.Magnetization, 1).setUnlocalizedName("MeteoriteLegs").setTextureName("MeteoriteLegs");
	public static final Item MeteoriteBoots 			= new ItemEnchArmor(MeteoriteArmor, 3, 3).setEnch(MeteorsMod.Magnetization, 1).setUnlocalizedName("MeteoriteBoots").setTextureName("MeteoriteBoots");
	...
	public static final Item FrezariteHelmet 			= new ItemEnchArmor(FrezariteArmor, 3, 0).setEnch(Enchantment.respiration, 3).setUnlocalizedName("FrezariteHelmet").setTextureName("FrezariteHelmet");
	public static final Item FrezariteBody 				= new ItemEnchArmor(FrezariteArmor, 3, 1).setEnch(Enchantment.aquaAffinity, 1).setUnlocalizedName("FrezariteChest").setTextureName("FrezariteChest");
	public static final Item FrezariteLegs 				= new ItemEnchArmor(FrezariteArmor, 3, 2).setEnch(MeteorsMod.ColdTouch, 1).setUnlocalizedName("FrezariteLegs").setTextureName("FrezariteLegs");
	public static final Item FrezariteBoots 			= new ItemEnchArmor(FrezariteArmor, 3, 3).setEnch(MeteorsMod.ColdTouch, 1).setUnlocalizedName("FrezariteBoots").setTextureName("FrezariteBoots");
	...
	public static final Item KreknoriteHelmet 			= new ItemEnchArmor(KreknoriteArmor, 3, 0).setEnch(Enchantment.fireProtection, 4).setUnlocalizedName("KreknoriteHelmet").setTextureName("KreknoriteHelmet");
	public static final Item KreknoriteBody 			= new ItemEnchArmor(KreknoriteArmor, 3, 1).setEnch(Enchantment.fireProtection, 4).setUnlocalizedName("KreknoriteChest").setTextureName("KreknoriteChest");
	public static final Item KreknoriteLegs 			= new ItemEnchArmor(KreknoriteArmor, 3, 2).setEnch(Enchantment.fireProtection, 4).setUnlocalizedName("KreknoriteLegs").setTextureName("KreknoriteLegs");
	public static final Item KreknoriteBoots 			= new ItemEnchArmor(KreknoriteArmor, 3, 3).setEnch(Enchantment.fireProtection, 4).setUnlocalizedName("KreknoriteBoots").setTextureName("KreknoriteBoots");
